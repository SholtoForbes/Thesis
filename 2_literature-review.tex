 	...
 	\begin{landscape}% Landscape page
 		\begin{table}
 			...
 			\begin{tabularx}{\linewidth}{|X|X|X|X|X|X|X|X|}
 				...
 				\hline 
 			\end{tabularx} 
 			\caption{A summary of some of the small satellite launchers, operational and in development.}
 			\label{tab:smallsats}
 		\end{table}
 	\end{landscape}
 }
...
\begin{figure}[h]
	...
	\end{minipage}
	\caption{The single stage-to-orbit vehicle of Powell et al \cite{Powell1991} and its launch trajectory, with pull-up manoeuvre evident.}
	\label{fig:Powell}
\end{figure}
