...
An exergy analysis is conducted on the maximum payload-to-orbit launch trajectories, both with, and without the SPARTAN constrained to constant dynamic pressure flight (Cases 1 \& 2). This is performed in order to understand the primary sources of exergy loss for each stage, and to compare the trajectories optimised with, and without the SPARTAN constrained to constant dynamic pressure. An exergy breakdown of each of each stage is compared in Table \ref{tab:effStandardNoReturn}. The exergy used to accelerate the payload is shown, along with the exergy wasted imparting energy to the successive stages; overcoming drag; imparting energy to the structural mass of each stage, which is separated; and lost due to propulsion inefficiency. 

From this exergy usage breakdown it can be observed that the exergy utilised by the first stage and the SPARTAN to impart energy to the payload is relatively low, compared to the exergy of the third stage utilised for this purpose, which is significantly higher. This is due to the larger mass fraction of the payload during the acceleration of the third stage, particularly during the Hohmann transfer, where large velocities are imparted. 
...
\textcolor{red}{describe the benefits of the pull-up and other manoeuvres in terms of exergy breakdown}
...
\begin{table}[ht!]
	...
	\\
	\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\firstExergyDestroyedqFortyNoReturn}
	& \textbf{\firstExergyDestroyedqFortyFiveNoReturn}
	& \textbf{\firstExergyDestroyedqStandardNoReturn}
	& \textbf{\firstExergyDestroyedqFiftyFiveNoReturn}
	& \textbf{\firstExergyDestroyedqSixtyNoReturn}
	& -
	\\
	\textbf{Separation Alt, 1$\rightarrow$2 (km)}
	...
	\\
	\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\secondExergyDestroyedqFortyNoReturn}
	& \textbf{\secondExergyDestroyedqFortyFiveNoReturn}
	& \textbf{\secondExergyDestroyedqStandardNoReturn}
	& \textbf{\secondExergyDestroyedqFiftyFiveNoReturn}
	& \textbf{\secondExergyDestroyedqSixtyNoReturn}
	& \textbf{-0.015}
	\\
	\textbf{Separation Alt, 2$\rightarrow$3 (km)}
	...
	\\
	\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\thirdExergyDestroyedqFortyNoReturn}
	& \textbf{\thirdExergyDestroyedqFortyFiveNoReturn}
	& \textbf{\thirdExergyDestroyedqStandardNoReturn}
	& \textbf{\thirdExergyDestroyedqFiftyFiveNoReturn}
	& \textbf{\thirdExergyDestroyedqSixtyNoReturn}
	& \textbf{-0.016}
	\\
	\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
\begin{table}[ht!]
	...
	\begin{tabular}{l c c c c c c} 
		...
		\\
		\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\firstExergyDestroyedCdNinetyNoReturn}
		& \textbf{\firstExergyDestroyedCdNinetyFiveNoReturn}
		& \textbf{\firstExergyDestroyedCdStandardNoReturn}
		& \textbf{\firstExergyDestroyedCdOneHundredFiveNoReturn}
		& \textbf{\firstExergyDestroyedCdOneHundredTenNoReturn}
		& -
		\\
		\textbf{Separation Alt, 1$\rightarrow$2 (km)}
		...
		\\
		\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\secondExergyDestroyedCdNinetyNoReturn}
		& \textbf{\secondExergyDestroyedCdNinetyFiveNoReturn}
		& \textbf{\secondExergyDestroyedCdStandardNoReturn}
		& \textbf{\secondExergyDestroyedCdOneHundredFiveNoReturn}
		& \textbf{\secondExergyDestroyedCdOneHundredTenNoReturn}
		& \textbf{0.069}
		\\
		\textbf{Separation Alt, 2$\rightarrow$3 (km)}
		...
		\\
		\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\thirdExergyDestroyedCdNinetyNoReturn}
		& \textbf{\thirdExergyDestroyedCdNinetyFiveNoReturn}
		& \textbf{\thirdExergyDestroyedCdStandardNoReturn}
		& \textbf{\thirdExergyDestroyedCdOneHundredFiveNoReturn}
		& \textbf{\thirdExergyDestroyedCdOneHundredTenNoReturn}
		& \textbf{0.08}
		\\
		\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
\textcolor{red}{XX done after exergy improvements, but check last line}
...
\begin{table}[ht!]
	...
	\begin{tabular}{l c c c c c c} 
		...
		\\
		\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\firstExergyDestroyedIspNinetyNoReturn}
		& \textbf{\firstExergyDestroyedIspNinetyFiveNoReturn}
		& \textbf{\firstExergyDestroyedIspStandardNoReturn}
		& \textbf{\firstExergyDestroyedIspOneHundredFiveNoReturn}
		& \textbf{\firstExergyDestroyedIspOneHundredTenNoReturn}
		& -
		\\
		\textbf{Separation Alt, 1$\rightarrow$2 (km)}
		...
		\\
		\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\secondExergyDestroyedIspNinetyNoReturn}
		& \textbf{\secondExergyDestroyedIspNinetyFiveNoReturn}
		& \textbf{\secondExergyDestroyedIspStandardNoReturn}
		& \textbf{\secondExergyDestroyedIspOneHundredFiveNoReturn}
		& \textbf{\secondExergyDestroyedIspOneHundredTenNoReturn}
		& \textbf{-0.121}
		\\
		\textbf{Separation Alt, 2$\rightarrow$3 (km)}
		...
		\\
		\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\thirdExergyDestroyedIspNinetyNoReturn}
		& \textbf{\thirdExergyDestroyedIspNinetyFiveNoReturn}
		& \textbf{\thirdExergyDestroyedIspStandardNoReturn}
		& \textbf{\thirdExergyDestroyedIspOneHundredFiveNoReturn}
		& \textbf{\thirdExergyDestroyedIspOneHundredTenNoReturn}
		& \textbf{-0.094}
		\\
		\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
The exergy efficiency of the third stage is increased as the specific impulse of the SPARTAN increases, varying by +2.339\%$\eta$ at 110\% $I_{SP}$ to -1.976\%$\eta$ at 90\% $I_{SP}$. This is due to the significantly decreased propulsive losses of the third stage when released at a higher velocity, \PlossthreeCombinedIspOneHundredTenNoReturn\% (16.10GJ) at 110\%$I_{SP}$, compared to \PlossthreeCombinedIspNinetyNoReturn\% (17.96GJ) at 90\%$I_{SP}$. 
...
\begin{table}[ht]
	...
	& $\Delta/\Delta$\%q
		...
		\\
		\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\firstExergyDestroyedmSPARTANNinetyFiveNoReturn}
		& \textbf{\firstExergyDestroyedmSPARTANNinetySevenFiveNoReturn}
		& \textbf{\firstExergyDestroyedmSPARTANStandardNoReturn}
		& \textbf{\firstExergyDestroyedmSPARTANOneHundredTwoFiveNoReturn}
		& \textbf{\firstExergyDestroyedmSPARTANOneHundredFiveNoReturn}
		& \textbf{-0.488}
		\\
		\textbf{Separation Alt, 1$\rightarrow$2 (km)}
		...
		\\
		\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\secondExergyDestroyedmSPARTANNinetyFiveNoReturn}
		& \textbf{\secondExergyDestroyedmSPARTANNinetySevenFiveNoReturn}
		& \textbf{\secondExergyDestroyedmSPARTANStandardNoReturn}
		& \textbf{\secondExergyDestroyedmSPARTANOneHundredTwoFiveNoReturn}
		& \textbf{\secondExergyDestroyedmSPARTANOneHundredFiveNoReturn}
		& \textbf{0.019}
		\\
		\textbf{Separation Alt, 2$\rightarrow$3 (km)}
		...
		\\
		\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\thirdExergyDestroyedmSPARTANNinetyFiveNoReturn}
		& \textbf{\thirdExergyDestroyedmSPARTANNinetySevenFiveNoReturn}
		& \textbf{\thirdExergyDestroyedmSPARTANStandardNoReturn}
		& \textbf{\thirdExergyDestroyedmSPARTANOneHundredTwoFiveNoReturn}
		& \textbf{\thirdExergyDestroyedmSPARTANOneHundredFiveNoReturn}
		& \textbf{0.065}
		\\
		\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
As the mass of the SPARTAN increases, the exergy efficiency of the third stage is decreased, varying by -0.76\%$\eta$ at 105\% structural mass, and as the SPARTAN mass is decreased, the exergy efficiency of the third stage is increased, varying by +0.722\%$\eta$ at 95\% structural mass, due to being released at a lower velocity. 
...
\begin{tabular}{l c c c c c c} 
	...
	\\
	\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\firstExergyDestroyedmFuelNinetyNoReturn}
	& \textbf{\firstExergyDestroyedmFuelNinetyFiveNoReturn}
	& \textbf{\firstExergyDestroyedmFuelStandardNoReturn}
	& \textbf{\firstExergyDestroyedmFuelOneHundredFiveNoReturn}
	& \textbf{\firstExergyDestroyedmFuelOneHundredTenNoReturn}
	& \textbf{-0.149}
	\\
	\textbf{Separation Alt, 1$\rightarrow$2 (km)}
	...
	\\
	\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\secondExergyDestroyedmFuelNinetyNoReturn}
	& \textbf{\secondExergyDestroyedmFuelNinetyFiveNoReturn}
	& \textbf{\secondExergyDestroyedmFuelStandardNoReturn}
	& \textbf{\secondExergyDestroyedmFuelOneHundredFiveNoReturn}
	& \textbf{\secondExergyDestroyedmFuelOneHundredTenNoReturn}
	& \textbf{1.812}
	\\
	\textbf{Separation Alt, 2$\rightarrow$3 (km)}
	...
	\\
	\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\thirdExergyDestroyedmFuelNinetyNoReturn}
	& \textbf{\thirdExergyDestroyedmFuelNinetyFiveNoReturn}
	& \textbf{\thirdExergyDestroyedmFuelStandardNoReturn}
	& \textbf{\thirdExergyDestroyedmFuelOneHundredFiveNoReturn}
	& \textbf{\thirdExergyDestroyedmFuelOneHundredTenNoReturn}
	& \textbf{-0.03}
	\\
	\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
\begin{table}[ht]
	...
	\begin{tabular}{l c c c c c c} 
		...
		\\
		\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\firstExergyDestroyedmThreeNinetyNoReturn}
		& \textbf{\firstExergyDestroyedmThreeNinetyFiveNoReturn}
		& \textbf{\firstExergyDestroyedmThreeStandardNoReturn}
		& \textbf{\firstExergyDestroyedmThreeOneHundredFiveNoReturn}
		& \textbf{\firstExergyDestroyedmThreeOneHundredTenNoReturn}
		& \textbf{-0.317}
		\\
		\textbf{Separation Alt, 1$\rightarrow$2 (km)}
		...
		\\
		\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\secondExergyDestroyedmThreeNinetyNoReturn}
		& \textbf{\secondExergyDestroyedmThreeNinetyFiveNoReturn}
		& \textbf{\secondExergyDestroyedmThreeStandardNoReturn}
		& \textbf{\secondExergyDestroyedmThreeOneHundredFiveNoReturn}
		& \textbf{\secondExergyDestroyedmThreeOneHundredTenNoReturn}
		& \textbf{-0.07}
		\\
		\textbf{Separation Alt, 2$\rightarrow$3 (km)}
		...
		\\
		\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\thirdExergyDestroyedmThreeNinetyNoReturn}
		& \textbf{\thirdExergyDestroyedmThreeNinetyFiveNoReturn}
		& \textbf{\thirdExergyDestroyedmThreeStandardNoReturn}
		& \textbf{\thirdExergyDestroyedmThreeOneHundredFiveNoReturn}
		& \textbf{\thirdExergyDestroyedmThreeOneHundredTenNoReturn}
		& \textbf{0.32}
		\\
		\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
\begin{table}[ht]
	...
	\begin{tabular}{l c c c c c c} 
		...
		\\
		\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\firstExergyDestroyedTThreeNinetyNoReturn}
		& \textbf{\firstExergyDestroyedTThreeNinetyFiveNoReturn}
		& \textbf{\firstExergyDestroyedTThreeStandardNoReturn}
		& \textbf{\firstExergyDestroyedTThreeOneHundredFiveNoReturn}
		& \textbf{\firstExergyDestroyedTThreeOneHundredTenNoReturn}
		& -
		\\
		\textbf{Separation Alt, 1$\rightarrow$2 (km)}
		...
		\\
		\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\secondExergyDestroyedTThreeNinetyNoReturn}
		& \textbf{\secondExergyDestroyedTThreeNinetyFiveNoReturn}
		& \textbf{\secondExergyDestroyedTThreeStandardNoReturn}
		& \textbf{\secondExergyDestroyedTThreeOneHundredFiveNoReturn}
		& \textbf{\secondExergyDestroyedTThreeOneHundredTenNoReturn}
		& \textbf{-0.004}
		\\
		\textbf{Separation Alt, 2$\rightarrow$3 (km)}
		...
		\\
		\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\thirdExergyDestroyedTThreeNinetyNoReturn}
		& \textbf{\thirdExergyDestroyedTThreeNinetyFiveNoReturn}
		& \textbf{\thirdExergyDestroyedTThreeStandardNoReturn}
		& \textbf{\thirdExergyDestroyedTThreeOneHundredFiveNoReturn}
		& \textbf{\thirdExergyDestroyedTThreeOneHundredTenNoReturn}
		& \textbf{-0.211}
		\\
		\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
As the specific impulse of the third stage is varied, the size and shape of the SPARTAN's trajectory and pull-up manoeuvre are only slightly affected by the specific impulse of the third stage rocket engine, with no consistent trend. 
 However, the exergy efficiency of the SPARTAN increases as the third stage specific impulse is increased, by +0.031\%$\eta$ (+0.66\%) at 105\% $I_{SP}$, and decreases as the third stage specific impulse is decreased, by -0.014\%$\eta$ (-0.030\%) at 95\% $I_{SP}$. This trend indicates that as the efficiency of the third stage increases, the trade-off between the efficiencies of the SPARTAN and the third stage shifts slightly to favour the SPARTAN. This trade-off shift is small, because the third stage specific impulse has a relatively minor effect of within the atmosphere, where the trade-off occurs. 
...
\begin{table}[ht]
	...
	\begin{tabular}{l c c c c c c} 
		...
		\\
		\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\firstExergyDestroyedCdThreeEightyNoReturn}
		& \textbf{\firstExergyDestroyedCdThreeNinetyNoReturn}
		& \textbf{\firstExergyDestroyedCdThreeStandardNoReturn}
		& \textbf{\firstExergyDestroyedCdThreeOneHundredTenNoReturn}
		& \textbf{\firstExergyDestroyedCdThreeOneHundredTwentyNoReturn}
		& -
		\\
		\textbf{Separation Alt, 1$\rightarrow$2 (km)}
		...
		\\
		\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\secondExergyDestroyedCdThreeEightyNoReturn}
		& \textbf{\secondExergyDestroyedCdThreeNinetyNoReturn}
		& \textbf{\secondExergyDestroyedCdThreeStandardNoReturn}
		& \textbf{\secondExergyDestroyedCdThreeOneHundredTenNoReturn}
		& \textbf{\secondExergyDestroyedCdThreeOneHundredTwentyNoReturn}
		& \textbf{0.004}
		\\
		\textbf{Separation Alt, 2$\rightarrow$3 (km)}
		...
		\\
		\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\thirdExergyDestroyedCdThreeEightyNoReturn}
		& \textbf{\thirdExergyDestroyedCdThreeNinetyNoReturn}
		& \textbf{\thirdExergyDestroyedCdThreeStandardNoReturn}
		& \textbf{\thirdExergyDestroyedCdThreeOneHundredTenNoReturn}
		& \textbf{\thirdExergyDestroyedCdThreeOneHundredTwentyNoReturn}
		& \textbf{0.002}
		\\
		\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
