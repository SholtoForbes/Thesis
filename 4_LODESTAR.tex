...
LODESTAR is developed in MATLAB and utilises GPOPS-2\cite{Patterson2015} a proprietary pseudospectral method optimisation package, which uses an hp-adaptive version of the Radau pseudospectral method, described in further detail in Section \ref{sec:optsolvers}.
