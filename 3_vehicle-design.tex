...
\end{figure}
	...
	\section{Second Stage Scramjet}\label{sec:SPARTAN}

	
		\subsection{The SPARTAN Accelerator}
		
		The SPARTAN vehicle, shown in Figure \ref{fig:SPARTANlabelled}, is based on the work by Preller \& Smart \cite{Preller2017b}. The SPARTAN is 22.94m long, with a frontal cone half angle of 5$^\circ$\cite{Preller2017b}. 
		\begin{figure}[ht]
			\centering
...
The mass of the fuel tanks is scaled, by area, from Dawid Preller's Baseline vehicle model of the SPARTAN\cite{Preller2017b}, giving a total fuel tank mass of 179.4kg.
