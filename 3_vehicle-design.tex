...
\end{figure}
	...
	\section{Second Stage Scramjet}\label{sec:SPARTAN}
		...
		The SPARTAN vehicle, shown in Figure \ref{fig:SPARTANlabelled}, is based on the work by Preller \& Smart CITATION. The SPARTAN is 22.94m long, with a frontal cone half angle of 5$^\circ$\cite{Preller2017b}. 
		\begin{figure}[ht]
			\centering
