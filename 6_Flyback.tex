...
An energy usage analysis is conducted for a maximum payload-to-orbit trajectory, including the fly-back of the SPARTAN. This is compared to the energy usage breakdown of the maximum payload-to-orbit trajectory, without the fly-back of the SPARTAN, in Table \ref{tab:effStandard}. Similarly to Section \ref{sec:exergy1}, the energy used to accelerate the payload is shown, along with the energy imparted to the successive stages; the energy used overcoming drag; the energy used imparting energy to the structural mass of each stage, which is separated; and the energy lost due to propulsion inefficiency. 



The first stage rocket starts with a larger fuel mass when the fly-back of the SPARTAN is included, and so starts with a larger fuel exergy. Overall, more of the energy of the first stage is imparted upon the combination of the payload, SPARTAN. and third stages, when SPARTAN fly-back is included (6.6\%, 14.37GJ, compared to 6.292\%, 13.12GJ, without SPARTAN fly-back). This is due to the rocket flying a more efficient trajectory, releasing the payload, SPARTAN, and third stage at a higher altitude and velocity.

The SPARTAN flies a slightly less efficient trajectory when fly-back is included, due to the less favourable separation conditions, and the high banking throughout the acceleration. 
The return of the SPARTAN reduces the fuel, and thus the exergy, available to the SPARTAN during ascent, causing less energy to be imparted to the payload and third stage, compared to the trajectory without fly-back. 
The energy necessary to return the SPARTAN to its initial launch location is provided by both the fuel used during the return (32.15GJ), as well as the kinetic and potential energy imparted upon the SPARTAN during its ascent (18.40GJ). Significantly more energy is required to overcome drag during the return (30.94GJ) than is available from the kinetic and potential energy of the SPARTAN (18.40 GJ), illustrating the necessity for the scramjet engines to be ignited during the return flight. 

The third stage is released from a lower, slower separation point, when fly-back is included, causing the efficiency of the third stage to decrease over all metrics. The propulsive inefficiency losses show a larger increase than the other sources of energy loss, due to the lower velocity of the separation point, which decresaes the propulsive efficiency of the third stage (illustrated by Equation \ref{eq:rocketeff}). 
