...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{../LODESTAR_FINAL/Results/mode21/SecondStageComparison}
\caption{}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{../LODESTAR_FINAL/Results/mode21/ReturnComparison}
\caption{}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{../LODESTAR_FINAL/Results/mode21/ThirdStageComparison}
\caption{}
