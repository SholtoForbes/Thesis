...
\subsection{Case 13: SPARTAN Drag Sensitivity with Fly-Back}
...
\subsection{Case 18: Third Stage $I_{SP}$ Sensitivity with Fly-Back}
...
This higher separation point serves to increase the total fuel of the first stage to 17943kg, as well as increasing its exergy efficiency to \firstExergyEffStandard \%$\eta$, increases of +758kg (+4.4\%) and +0.308\%$\eta$ (+4.9\%) respectively when compared to the maximum payload-to-orbit trajectory with no fly-back.
