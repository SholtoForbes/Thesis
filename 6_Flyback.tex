...
\textcolor{red}{exergy can be affected by the amount of fuel (as its variable), and keep this is mind during discussion. -i dont think using specific exergy is  useful though, comment on exergy changes in main trajectory}
