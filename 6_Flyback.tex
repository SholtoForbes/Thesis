...
\begin{tabular}{l c } 
	...
	& \textbf{\firstExergyDestroyedStandard}
	\\
	...
	& \textbf{\secondExergyDestroyedStandard}
	\\
	...
	& \textbf{\thirdExergyDestroyedStandard}
	\\
...
\section{Exergy Utilisation Analysis}
...
\begin{table}[ht]
	...
	\begin{tabular}{l c c} 
		...
		& \firstWpayloadStandard \%
		\\
		\textcolor{red}{KE + PE of  2$^{nd}$ \& 3$^{rd}$ Stage}
		& \firstWnextStageStandardNoReturn \% & \firstWnextStageStandard \%
		\\
			\textcolor{red}{KE + PE of 1$^{st}$ Stage Structural Mass} 
			& \WoneStandardNoReturn \% & \WoneStandard \%
			\\
		\textcolor{red}{Overcoming Drag} 
		& \WDoneStandardNoReturn \% & \WDoneStandard \%
		\\
	
		\textcolor{red}{Propulsion Inefficiency} 
		& \PlossoneCombinedStandardNoReturn \% & \PlossoneCombinedStandard \%
		\\ 
		\textbf{Total SPARTAN Exergy} 
		& \textbf{\secondEnergyStandardNoReturn} GJ & \textbf{\secondEnergyStandard} GJ
		\\
		\textcolor{blue}{KE + PE of Payload}
		& \secondWpayloadStandardNoReturn \% & \secondWpayloadStandard \%
		\\
		\textcolor{red}{KE + PE of 3$^{rd}$ Stage}
		& \secondWnextStageStandardNoReturn \% & \secondWnextStageStandard \%
		\\
		\textcolor{red}{Overcoming Drag}
		& \WDsecondStandardNoReturn \% & \WDsecondStandard \%
		\\
		\textcolor{red}{KE + PE of SPARTAN Structural Mass}  
		& \WsecondStandardNoReturn \% & \WsecondStandard \%
		\\
		\textcolor{red}{Propulsion Inefficiency}  
		& \PlosssecondCombinedStandardNoReturn \% & \PlosssecondCombinedStandard \%
		\\
		
		
		
		\textbf{Total Return Exergy} 
		& - & \textbf{\returnEnergyStandard} GJ
		\\
				\textcolor{blue}{KE + PE of SPARTAN Structural Mass}  
				& - & \WreturnStandard \%
				\\
		\textcolor{red}{Overcoming Drag}
		& - & \WDreturnStandard \%
		...
		\\
		\textcolor{blue}{KE + PE of Payload}  
		&\thirddExergyEffStandardNoReturn \% &\thirddExergyEffStandard \%
		\\
		\textcolor{red}{KE + PE  of 3$^{rd}$ Stage Structural Mass}  
		& \WthreeStandardNoReturn \% & \WthreeStandard \%
		\\
		\textcolor{red}{Overcoming Drag}  
		& \WDthreeStandardNoReturn \% & \WDthreeStandard \%
		\\
		
		
		\textcolor{red}{KE + PE of Heat Shield}  
		
		& \WHSthreeStandardNoReturn \% & \WHSthreeStandard \%
		\\
		
		\textcolor{red}{Propulsion Inefficiency}  
		& \PlossthreeCombinedStandardNoReturn \% & \PlossthreeCombinedStandard \%
		\\
		\hline 
	\end{tabular} 
	\caption{An exergy usage breakdown of the ascent trajectories, both with, and without, SPARTAN fly-back (Cases 2 \& 11). Blue indicates a 'productive' exergy usage, whereas red indicates exergy 'wastage'.}
	\label{tab:effStandard}
\end{table}


\section{Design Sensitivity Analysis}\label{sec:sensitivity}
\textcolor{red}{XX note: exergy breakdown calculations were done without return, will need to redo if I want to talk about them}
...
\begin{table}[ht]
	...
	\begin{tabular}{l c c c c c c} 
		...
		\\
		\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\firstExergyDestroyedIspNinety}
		& \textbf{\firstExergyDestroyedIspNinetyFive}
		& \textbf{\firstExergyDestroyedIspStandard}
		& \textbf{\firstExergyDestroyedIspOneHundredFive}
		& \textbf{\firstExergyDestroyedIspOneHundredTen}
		& -
		\\
		\textbf{Separation Alt, 1$\rightarrow$2 (km)}
		...
		\\
		\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\secondExergyDestroyedIspNinety}
		& \textbf{\secondExergyDestroyedIspNinetyFive}
		& \textbf{\secondExergyDestroyedIspStandard}
		& \textbf{\secondExergyDestroyedIspOneHundredFive}
		& \textbf{\secondExergyDestroyedIspOneHundredTen}
		& \textbf{-0.095}
		\\
		\textbf{Separation Alt, 2$\rightarrow$3 (km)}
		...
		\\
		\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\thirdExergyDestroyedIspNinety}
		& \textbf{\thirdExergyDestroyedIspNinetyFive}
		& \textbf{\thirdExergyDestroyedIspStandard}
		& \textbf{\thirdExergyDestroyedIspOneHundredFive}
		& \textbf{\thirdExergyDestroyedIspOneHundredTen}
		& \textbf{-0.073}
		\\
		\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
\begin{tabular}{l c c c c c c} 
	...
	\\
	\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\firstExergyDestroyedmSPARTANNinetyFive}
	& \textbf{\firstExergyDestroyedmSPARTANNinetySevenFive}
	& \textbf{\firstExergyDestroyedmSPARTANStandard}
	& \textbf{\firstExergyDestroyedmSPARTANOneHundredTwoFive}
	& \textbf{\firstExergyDestroyedmSPARTANOneHundredFive}
	& \textbf{0.061}
	\\
	\textbf{Separation Alt, 1$\rightarrow$2 (km)}
	...
	\\
	\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\secondExergyDestroyedmSPARTANNinetyFive}
	& \textbf{\secondExergyDestroyedmSPARTANNinetySevenFive}
	& \textbf{\secondExergyDestroyedmSPARTANStandard}
	& \textbf{\secondExergyDestroyedmSPARTANOneHundredTwoFive}
	& \textbf{\secondExergyDestroyedmSPARTANOneHundredFive}
	& \textbf{0.03}
	\\
	\textbf{Separation Alt, 2$\rightarrow$3 (km)}
	...
	\\
	\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\thirdExergyDestroyedmSPARTANNinetyFive}
	& \textbf{\thirdExergyDestroyedmSPARTANNinetySevenFive}
	& \textbf{\thirdExergyDestroyedmSPARTANStandard}
	& \textbf{\thirdExergyDestroyedmSPARTANOneHundredTwoFive}
	& \textbf{\thirdExergyDestroyedmSPARTANOneHundredFive}
	& \textbf{0.059}
	\\
	\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
\begin{tabular}{l c c c c c c} 
	...
	\\
	\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\firstExergyDestroyedmFuelNinety}
	& \textbf{\firstExergyDestroyedmFuelNinetyFive}
	& \textbf{\firstExergyDestroyedmFuelStandard}
	& \textbf{\firstExergyDestroyedmFuelOneHundredFive}
	& \textbf{\firstExergyDestroyedmFuelOneHundredTen}
	& -
	\\
	\textbf{Separation Alt, 1$\rightarrow$2 (km)}
	...
	\\
	\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\secondExergyDestroyedmFuelNinety}
	& \textbf{\secondExergyDestroyedmFuelNinetyFive}
	& \textbf{\secondExergyDestroyedmFuelStandard}
	& \textbf{\secondExergyDestroyedmFuelOneHundredFive}
	& \textbf{\secondExergyDestroyedmFuelOneHundredTen}
	& \textbf{1.823}
	\\
	\textbf{Separation Alt, 2$\rightarrow$3 (km)}
	...
	\\
	\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
	& \textbf{\thirdExergyDestroyedmFuelNinety}
	& \textbf{\thirdExergyDestroyedmFuelNinetyFive}
	& \textbf{\thirdExergyDestroyedmFuelStandard}
	& \textbf{\thirdExergyDestroyedmFuelOneHundredFive}
	& \textbf{\thirdExergyDestroyedmFuelOneHundredTen}
	& \textbf{-0.03}
	\\
	\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
\begin{table}[ht]
	...
	\begin{tabular}{l c c c c c c} 
		...
		\\
		\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\firstExergyDestroyedmThreeNinety}
		& \textbf{\firstExergyDestroyedmThreeNinetyFive}
		& \textbf{\firstExergyDestroyedmThreeStandard}
		& \textbf{\firstExergyDestroyedmThreeOneHundredFive}
		& \textbf{\firstExergyDestroyedmThreeOneHundredTen}
		& \textbf{0.042}
		\\
		\textbf{Separation Alt, 1$\rightarrow$2 (km)}
		...
		\\
		\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\secondExergyDestroyedmThreeNinety}
		& \textbf{\secondExergyDestroyedmThreeNinetyFive}
		& \textbf{\secondExergyDestroyedmThreeStandard}
		& \textbf{\secondExergyDestroyedmThreeOneHundredFive}
		& \textbf{\secondExergyDestroyedmThreeOneHundredTen}
		& \textbf{-0.054}
		\\
		\textbf{Separation Alt, 2$\rightarrow$3 (km)}
		...
		\\
		\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\thirdExergyDestroyedmThreeNinety}
		& \textbf{\thirdExergyDestroyedmThreeNinetyFive}
		& \textbf{\thirdExergyDestroyedmThreeStandard}
		& \textbf{\thirdExergyDestroyedmThreeOneHundredFive}
		& \textbf{\thirdExergyDestroyedmThreeOneHundredTen}
		& \textbf{0.317}
		\\
		\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
...
\begin{table}[ht]
	...
	\begin{tabular}{l c c c c c c} 
		...
		\\
		\textbf{1$^{st}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\firstExergyDestroyedISPThreeNinety}
		& \textbf{\firstExergyDestroyedISPThreeNinetyFive}
		& \textbf{\firstExergyDestroyedISPThreeStandard}
		& \textbf{\firstExergyDestroyedISPThreeOneHundredFive}
		& \textbf{\firstExergyDestroyedISPThreeOneHundredTen}
		& \textbf{-0.004}
		\\
		\textbf{Separation Alt, 1$\rightarrow$2 (km)}
		...
		\\
		\textbf{2$^{nd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\secondExergyDestroyedISPThreeNinety}
		& \textbf{\secondExergyDestroyedISPThreeNinetyFive}
		& \textbf{\secondExergyDestroyedISPThreeStandard}
		& \textbf{\secondExergyDestroyedISPThreeOneHundredFive}
		& \textbf{\secondExergyDestroyedISPThreeOneHundredTen}
		& -
		\\
		\textbf{Separation Alt, 2$\rightarrow$3 (km)}
		...
		\\
		\textbf{3$^{rd}$ Stage Destroyed Exergy (GJ)}
		& \textbf{\thirdExergyDestroyedISPThreeNinety}
		& \textbf{\thirdExergyDestroyedISPThreeNinetyFive}
		& \textbf{\thirdExergyDestroyedISPThreeStandard}
		& \textbf{\thirdExergyDestroyedISPThreeOneHundredFive}
		& \textbf{\thirdExergyDestroyedISPThreeOneHundredTen}
		& \textbf{-0.211}
		\\
		\textbf{3$^{rd}$ Stage $t$, $q >$ 5kpa (s)}
